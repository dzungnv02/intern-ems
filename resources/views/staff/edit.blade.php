...
@endsection
@section('content')
<form action="" method="post" id="frmEditStaff">
   ...
   <div class="form-group row">
	...
	<div class="form-group row">
		<div class="col-sm-2">
			<button class="btn btn-primary" id="btnSave" type="button">Lưu</button>
		</div>
		<div class="col-sm-2">
			<button type="button" class="btn btn-warning" id="btnCancel" onclick="location.href='staff-list/'">Huỷ</button>
		</div>
	</div>
</form>
@endsection
